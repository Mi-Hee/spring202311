...
public class Ex04 {
    public static void main(String[] args) throws ClassNotFoundException {
        ...
        try(Connection conn = DriverManager.getConnection(url, username, password); PreparedStatement pstmt = conn.prepareStatement(sql, new String[] {"USER_NO"})) {
            ...
            e.printStackTrace();
            System.out.println("Ex04 - SQLException e 오류 발생");
        }

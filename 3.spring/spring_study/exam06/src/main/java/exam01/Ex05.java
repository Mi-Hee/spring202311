...
public class Ex05 {
    public static void main(String[] args) throws ClassNotFoundException {
        ...
        try (Connection conn = DriverManager.getConnection(url, username, password); PreparedStatement pstmt = conn.prepareStatement(sql); ResultSet rs = pstmt.executeQuery()) {
            ...
            e.printStackTrace();
            System.out.println("Ex05 - SQLException e 오류 발생");
